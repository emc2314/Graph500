...
#ifndef __REDUCE3_CU__
#define __REDUCE3_CU__
...
__device__ void REDUCE_COUNT_FUNC3//(void* key, void* vals, size_t keySize, size_t valCount)
{
  EMIT_COUNT_FUNC(sizeof(int), sizeof(int));
}

__device__ void REDUCE_FUNC3//(void* key, void* vals, size_t keySize, size_t valCount)
{
  int i;
  int sum = 0;
