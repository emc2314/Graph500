...
__device__ void MAP_COUNT_FUNC3//(void *key, void *val, size_t keySize, size_t valSize)
{
  EMIT_INTER_COUNT_FUNC(sizeof(int), sizeof(int));
}

__device__ void MAP_FUNC3//(void *key, void val, size_t keySize, size_t valSize)
{
